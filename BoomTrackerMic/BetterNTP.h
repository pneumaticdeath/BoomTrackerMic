...
class NTPClient {
  private:
    ...
    unsigned long _correction     = 1000000;// In microseconds as measured by micros() per real second
    signed long   _skew           = 0;      // In microseconds, the amount to skew forward or back over the first second after update
